...
import com.okta.example.sdk.impl.http.authc.DefaultRequestAuthenticatorFactory;
import com.okta.example.sdk.impl.http.authc.RequestAuthenticator;
import com.okta.example.sdk.impl.http.authc.RequestAuthenticatorFactory;
import com.okta.example.sdk.impl.http.support.BackoffStrategy;
import com.okta.example.sdk.impl.http.support.DefaultRequest;
import com.okta.example.sdk.impl.http.support.DefaultResponse;
...
public class HttpClientRequestExecutor implements RequestExecutor {
    ...
    private static final String MAX_CONNECTIONS_PER_ROUTE_PROPERTY_KEY = "com.okta.example.sdk.impl.http.httpclient.HttpClientRequestExecutor.connPoolControl.maxPerRoute";
    ...
    private static final String MAX_CONNECTIONS_TOTAL_PROPERTY_KEY = "com.okta.example.sdk.impl.http.httpclient.HttpClientRequestExecutor.connPoolControl.maxTotal";
