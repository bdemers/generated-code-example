...
import com.okta.example.sdk.impl.test.RestoreSecurityManager
...
class DefaultClientTest {
    ...
    void testCreateRequestExecutor() {
        ...
        def className = "com.okta.example.sdk.impl.http.httpclient.HttpClientRequestExecutor"
        ...
        System.setSecurityManager(new SecurityManager() {
            ...
            void checkPackageAccess(String pkg) {
                if ("com.okta.example.sdk.impl.http.httpclient".equals(pkg)) {
