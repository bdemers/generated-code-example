...
public class StubResource extends AbstractResource {
    ...
    private final Map<String, Property> propertyDescriptors = createPropertyDescriptorMap(booleanProp, dateProp, enumListProp, enumProp, integerProp, doubleProp, listProp, mapProp, resourceListProp, stringProp, charArrayProp1, charArrayProp2);
