...
package com.okta.example.sdk.impl.util;

import com.okta.example.sdk.lang.Assert;
import com.okta.example.sdk.lang.Objects;
...
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    public MimeType(String type, String subtype, Map<String, String> parameters) {
        ...
        if (!com.okta.example.sdk.lang.Collections.isEmpty(parameters)) {
    ...
    private boolean parametersAreEqual(MimeType other) {
        ...
        for (String key : this.parameters.keySet()) {
            ...
            if (PARAM_CHARSET.equals(key)) {
                if (!Objects.nullSafeEquals(getCharset(), other.getCharset())) {
                    return false;
                }
            }
            else if (!Objects.nullSafeEquals(this.parameters.get(key), other.parameters.get(key))) {
                return false;
            }
        }
     ...
     * (as supported by {@code org.springframework.core.convert.ConversionService}.
     * @see MimeTypeUtils#parseMimeType(String)
     * @param value string to parse
     * @return MimeType base on {@code value}
     */
