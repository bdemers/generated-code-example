...
import com.okta.example.sdk.impl.util.MultiValueMap;
import com.okta.example.sdk.http.HttpMethod;
import com.okta.example.sdk.impl.util.LinkedCaseInsensitiveMap;
import com.okta.example.sdk.impl.util.MultiValueMap;
...
public class HttpHeaders implements MultiValueMap<String, String> {
    ...
    public static final String OKTA_AGENT = "X-Okta-Agent";
    ...
    public Map<String, String> getLinkMap() {
        ...
        if (!com.okta.example.sdk.lang.Collections.isEmpty(links)) {
