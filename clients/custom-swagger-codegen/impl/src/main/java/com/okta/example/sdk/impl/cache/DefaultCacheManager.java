 ...
 */
package com.okta.example.sdk.impl.cache;

import com.okta.example.sdk.cache.Cache;
import com.okta.example.sdk.cache.CacheManager;
import com.okta.example.sdk.impl.util.SoftHashMap;
import com.okta.example.sdk.lang.Assert;
import com.okta.example.sdk.lang.Duration;
 ...
 * <em>strongly</em> recommended that you configure the Okta Example SDK with a clustered {@code CacheManager}
 ...
 * <p>
 * This implementation's {@link #setDefaultTimeToIdle(com.okta.example.sdk.lang.Duration) defaultTimeToIdle}
 ...
 * <p>
 * The {@link #setDefaultTimeToIdle(com.okta.example.sdk.lang.Duration) defaultTimeToIdle} setting is only
 ...
 * <p>
 * This implementation's {@link #setDefaultTimeToLive(com.okta.example.sdk.lang.Duration) defaultTimeToLive}
 ...
 * <p>
 * The {@link #setDefaultTimeToLive(com.okta.example.sdk.lang.Duration) defaultTimeToLive} setting is only
 * applied to newly created {@code Cache} instances.  It does not affect already existing {@code Cache}s.
 * <h2>Thread Safety</h2>
 * This implementation and the cache instances it creates are thread-safe and usable in concurrent environments.
 *
 * @see #setDefaultTimeToIdle(com.okta.example.sdk.lang.Duration)
 * @see #setDefaultTimeToIdleSeconds(long)
 * @see #setDefaultTimeToLive(com.okta.example.sdk.lang.Duration)
...
public class DefaultCacheManager implements CacheManager {
    ...
    /**
     * Convenience method that sets the {@link #setDefaultTimeToLive(com.okta.example.sdk.lang.Duration) defaultTimeToLive}
     * value using a {@code TimeUnit} of {@link TimeUnit#SECONDS}.
     *
     * @param seconds the {@link #setDefaultTimeToLive(com.okta.example.sdk.lang.Duration) defaultTimeToLive} value in seconds.
     */
    ...
    /**
     * Convenience method that sets the {@link #setDefaultTimeToIdle(com.okta.example.sdk.lang.Duration) defaultTimeToIdle}
     * value using a {@code TimeUnit} of {@link TimeUnit#SECONDS}.
     *
     * @param seconds the {@link #setDefaultTimeToIdle(com.okta.example.sdk.lang.Duration) defaultTimeToIdle} value in seconds.
     */
