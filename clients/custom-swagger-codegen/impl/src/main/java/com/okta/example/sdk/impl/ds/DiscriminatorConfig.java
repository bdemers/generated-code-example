...
public class DiscriminatorConfig {
    ...
    /**
     * Loads DiscriminatorConfig from the classpath file: {code}/com/okta/example/sdk/resource/discrimination.yaml{code}.
    ...
    static DiscriminatorConfig loadConfig() {
        Yaml yaml = new Yaml();
        String configFile = "/com/okta/example/sdk/resource/discrimination.yaml";
