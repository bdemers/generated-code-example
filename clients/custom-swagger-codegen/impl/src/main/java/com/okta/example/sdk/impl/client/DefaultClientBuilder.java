...
import com.okta.example.sdk.cache.CacheConfigurationBuilder;
import com.okta.example.sdk.cache.CacheManager;
import com.okta.example.sdk.cache.CacheManagerBuilder;
import com.okta.example.sdk.cache.Caches;
...
import com.okta.example.sdk.impl.api.DefaultClientCredentialsResolver;
import com.okta.example.sdk.authc.credentials.ClientCredentials;
import com.okta.example.sdk.impl.config.ClientConfiguration;
import com.okta.example.sdk.impl.config.EnvironmentVariablesPropertiesSource;
import com.okta.example.sdk.impl.config.OptionalPropertiesSource;
import com.okta.example.sdk.impl.config.PropertiesSource;
import com.okta.example.sdk.impl.config.ResourcePropertiesSource;
import com.okta.example.sdk.impl.config.SystemPropertiesSource;
import com.okta.example.sdk.impl.config.YAMLPropertiesSource;
import com.okta.example.sdk.impl.http.authc.RequestAuthenticatorFactory;
import com.okta.example.sdk.impl.io.ClasspathResource;
import com.okta.example.sdk.impl.io.DefaultResourceFactory;
import com.okta.example.sdk.impl.io.Resource;
import com.okta.example.sdk.impl.io.ResourceFactory;
 ...
 * <ul>
 * <li>classpath:com/okta/example/sdk/config/okta.properties</li>
...
public class DefaultClientBuilder implements ClientBuilder {
    ...
    private static final String OKTA_YAML      = "example-okta.yaml";
    ...
    private static final String[] DEFAULT_OKTA_PROPERTIES_FILE_LOCATIONS = {
                                                 ClasspathResource.SCHEME_PREFIX + "com/okta/example/sdk/config/" + OKTA_YAML,
