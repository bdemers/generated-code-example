...
import com.okta.example.sdk.impl.cache.DisabledCacheManager;
import com.okta.example.sdk.impl.ds.cache.CacheResolver;
import com.okta.example.sdk.impl.ds.cache.DefaultCacheResolver;
import com.okta.example.sdk.impl.ds.cache.DefaultResourceCacheStrategy;
import com.okta.example.sdk.impl.ds.cache.ReadCacheFilter;
import com.okta.example.sdk.impl.ds.cache.ResourceCacheStrategy;
import com.okta.example.sdk.impl.ds.cache.WriteCacheFilter;
import com.okta.example.sdk.impl.error.DefaultError;
import com.okta.example.sdk.impl.http.CanonicalUri;
import com.okta.example.sdk.impl.http.HttpHeaders;
import com.okta.example.sdk.impl.http.HttpHeadersHolder;
import com.okta.example.sdk.impl.http.MediaType;
...
import com.okta.example.sdk.impl.http.support.DefaultCanonicalUri;
import com.okta.example.sdk.impl.http.support.DefaultRequest;
import com.okta.example.sdk.impl.http.support.UserAgent;
...
import com.okta.example.sdk.impl.resource.HalResourceHrefResolver;
import com.okta.example.sdk.impl.resource.ReferenceFactory;
import com.okta.example.sdk.impl.util.BaseUrlResolver;
import com.okta.example.sdk.impl.util.DefaultBaseUrlResolver;
import com.okta.example.sdk.authc.credentials.ClientCredentials;
import com.okta.example.sdk.cache.CacheManager;
import com.okta.example.sdk.ds.DataStore;
import com.okta.example.sdk.http.HttpMethod;
import com.okta.example.sdk.impl.api.ClientCredentialsResolver;
import com.okta.example.sdk.impl.cache.DisabledCacheManager;
import com.okta.example.sdk.impl.ds.cache.CacheResolver;
import com.okta.example.sdk.impl.ds.cache.DefaultCacheResolver;
...
import com.okta.example.sdk.resource.CollectionResource;
...
import static com.okta.example.sdk.impl.http.HttpHeaders.OKTA_AGENT;
import static com.okta.example.sdk.impl.http.HttpHeaders.OKTA_CLIENT_REQUEST_ID;
...
//        }
    ...
    protected void applyDefaultRequestHeaders(Request request) {
        ...
        String oktaAgentHeaderName = HttpHeaders.OKTA_AGENT.toLowerCase(Locale.ENGLISH);
        ...
        if (headerMap != null && (clientRequestId = headerMap.get(HttpHeaders.OKTA_CLIENT_REQUEST_ID)) != null) {
            request.getHeaders().put(HttpHeaders.OKTA_CLIENT_REQUEST_ID, clientRequestId);
        }
    }
