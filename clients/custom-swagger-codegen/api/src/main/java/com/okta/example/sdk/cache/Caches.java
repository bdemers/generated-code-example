 ...
 */
package com.okta.example.sdk.cache;
...
public class Caches {
    ...
    public static CacheManagerBuilder newCacheManager() {
        return (CacheManagerBuilder) Classes.newInstance("com.okta.example.sdk.impl.cache.DefaultCacheManagerBuilder");
    }
    ...
    public static CacheManager newDisabledCacheManager() {
        return (CacheManager) Classes.newInstance("com.okta.example.sdk.impl.cache.DisabledCacheManager");
    }
    ...
    public static CacheConfigurationBuilder named(String name) {
        return (CacheConfigurationBuilder) Classes.newInstance("com.okta.example.sdk.impl.cache.DefaultCacheConfigurationBuilder", name);
    }
