 ...
 */
package com.okta.example.sdk.client;
 ...
 * Client client = {@link Clients Clients}.builder().<b>setCacheManager(cacheManager)</b>.build();
 * </pre>
 *
 ...
 *
 * <pre>
 * import static com.okta.example.sdk.cache.Caches.*;
 *
 * ...
 *
 * {@link com.okta.example.sdk.cache.Caches Caches}.{@link com.okta.example.sdk.cache.Caches#newCacheManager() newCacheManager()}
 *     .withDefaultTimeToLive(300, TimeUnit.SECONDS) // default
 *     .withDefaultTimeToIdle(300, TimeUnit.SECONDS) //general default
 *     .withCache({@link com.okta.example.sdk.cache.Caches#forResource(Class) forResource}(Account.class) //Account-specific cache settings
 *         .withTimeToLive(1, TimeUnit.HOURS)
 *         .withTimeToIdle(30, TimeUnit.MINUTES))
 *     .withCache({@link com.okta.example.sdk.cache.Caches#forResource(Class) forResource}(Group.class) //Group-specific cache settings
 ...
 * </pre>
 *
 * <p>See the {@link com.okta.example.sdk.cache.Caches Caches} utility class and the
 * {@link com.okta.example.sdk.cache.CacheManagerBuilder CacheManagerBuilder} docs for more information.</p>
 *
 ...
 *
 * <pre>
 * import com.okta.example.sdk.hazelcast.HazelcastCacheManager;
 * // ... etc ...
 *
 ...
 * Client client = {@link Clients Clients}.builder().setCacheManager(cacheManager).build();
 * </pre>
 *
 ...
 *
 * <pre>
 * Client client = {@link Clients Clients}.builder().setCacheManager(
 ...
 *
 * <p>As mentioned above, a client has a {@link #setCacheManager(com.okta.example.sdk.cache.CacheManager) CacheManager}
...
public interface ClientBuilder {
     ...
     *
     * Currently you should use a com.okta.example.sdk.impl.api.TokenClientCredentials (if you are NOT using an okta.yaml file)
     *
     ...
     * {@link com.okta.example.sdk.cache.CacheManagerBuilder CacheManagerBuilder} should be sufficient for your needs. You
     * create a {@code CacheManagerBuilder} by using the {@link com.okta.example.sdk.cache.Caches Caches} utility class,
     * for example:</p>
     *
     * <pre>
     * import static com.okta.example.sdk.cache.Caches.*;
     ...
     *     .setCacheManager(
     *         {@link com.okta.example.sdk.cache.Caches#newCacheManager() newCacheManager()}
     ...
     * {@link com.okta.example.sdk.cache.CacheManagerBuilder CacheManagerBuilder} might not be sufficient for a
     * multi-instance application that runs on multiple JVMs and/or hosts/servers, as there could be cache-coherency
     * problems across the JVMs.  See the {@link com.okta.example.sdk.cache.CacheManagerBuilder CacheManagerBuilder}
     ...
     * via this method.  Hazelcast is one known cluster-safe caching product, and the Okta Example SDK has out-of-the-box
